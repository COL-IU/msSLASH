...
//float Distance::cosine(const Spectrum& lhs, const Spectrum& rhs) {
//  return Distance::cosine(lhs._embeded_peaks,  rhs._embeded_peaks);
//}

//float Distance::cosine(const Spectrum& lhs, const Spectrum& rhs, float precision) {
//  return Distance::cosine(lhs._filtered_peaks, rhs._filtered_peaks, precision);
//}
